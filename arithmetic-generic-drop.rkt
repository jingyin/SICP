...
(define (install-real-package)
  ...
  (put 'raise '(real) (lambda (r) (make-complex-from-real-imag r 0.0)))
...
(define (install-complex-package)
  ...
  (put 'project '(complex) (lambda (c) (make-real (real-part c))))
  'done)
...
(project (make-complex-from-real-imag 10 20))
(project (make-complex-from-mag-ang 10 20))
