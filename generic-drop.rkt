...
; drops a given object to the lowest level in the hierarchy without losing information
; repeatedly project an object down, and verify raise gives back the same object
(define (drop x)
